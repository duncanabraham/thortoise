/* global describe, it */
const madgwick = require('../lib/madgwick')
...
describe('The Madgwick the calculations', () => {
  it('should take the input data and return the expected result', () => {
    ...
    expect(result.roll).to.be.almost(expected.roll, 0.1)
    expect(result.pitch).to.be.almost(expected.pitch, 0.1)
    expect(result.heading).to.be.almost(expected.yaw, 0.1)
  })
})
