...
const move = (thisPos, tick) => {
  const stepSize = (Math.PI * 2) / 180 // 2 degrees per step
  let step = tick * stepSize + thisPos.startPos // how far around are we
