...
class QMC5883L extends I2cBase {
  ...
  _azimuth () {
    ...
    const xDeg = roundDeg((this.rawValues.t1 / maxDeflection) * 360) // degrees as 90 == north
    const yDeg = roundDeg((this.rawValues.t2 / maxDeflection) * 360) // degrees as 270 == north
