...
class QMC5883L extends I2cBase {
  ...
  heading () {
    ...
    const angles = [0, 0, 90, 45, 180, 0, 135, 0, 270, 315, 0, 0, 225, 0, 0, 0, 0, 0]
    const avg = this.smoothed.avg()
