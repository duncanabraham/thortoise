...
class QMC5883L extends I2cBase {
  ...
  getHeading () {
    const angles = [-1, 0, 90, 45, 180, -2, 135, -3, 270, 315, -4, -5, 225, -6, -7, -8]
    ...
    const quartX = (calibrationMax.t1 - calibrationMin.t1) / 4
    const quartY = (calibrationMax.t2 - calibrationMin.t2) / 4
    this._heading = 0
