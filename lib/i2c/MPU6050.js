...
class MPU6050 extends i2cBase {
  ...
  getAccelData (g = false) {
    ...
    const x = this._readHL(this.ACCEL_XOUT0) / 8 // range.modifier
    const y = this._readHL(this.ACCEL_YOUT0) / 8 // range.modifier
    const z = this._readHL(this.ACCEL_ZOUT0) / 8 // range.modifier
  ...
  getGyroData () {
    ...
    const x = this._readHL(this.GYRO_XOUT0) / 8 // range.modifier
    const y = this._readHL(this.GYRO_YOUT0) / 8 // range.modifier
    const z = this._readHL(this.GYRO_ZOUT0) / 8 // range.modifier
