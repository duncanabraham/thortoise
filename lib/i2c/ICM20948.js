...
class ICM20948 extends i2cBase {
  ...
  async icm20948MagRead() {
    ...
    if (counter != 0) {
      ...
      this.mag[0] = (U8tempX[0] + U8tempX[1] + U8tempX[2] + U8tempX[3] + U8tempX[4] + U8tempX[5] + U8tempX[6] + U8tempX[7]) / 8
      this.mag[1] = -(U8tempY[0] + U8tempY[1] + U8tempY[2] + U8tempY[3] + U8tempY[4] + U8tempY[5] + U8tempY[6] + U8tempY[7]) / 8
      this.mag[2] = -(U8tempZ[0] + U8tempZ[1] + U8tempZ[2] + U8tempZ[3] + U8tempZ[4] + U8tempZ[5] + U8tempZ[6] + U8tempZ[7]) / 8
    }
