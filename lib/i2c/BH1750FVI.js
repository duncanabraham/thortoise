...
class BH1750FVI extends i2cBase {
  ...
  _init () {
    this._writeByte(0x00, this.POWER_ON, 'BH1750FVI:_init():1')
    this._writeByte(0x00, this.ONE_TIME_HRES_MODE, 'BH1750FVI:_init():2')
  }

  async readValue () {
    this.lastValue = toN(this._readHL(this.ONE_TIME_HRES_MODE) / 1.2, 3)
