...
class Pos extends Triplet {
  ...
  constructor (x, y, z, name, startPos, femurLength, tibiaLength) {
    super(x, y, z)
    Object.assign(this, { name, startPos, femurLength, tibiaLength, distanceFromHipToFoot: 0, angleAtFemur: 0, angleAtKnee: 0, angleAtHip: 0 })
    this._calcPosition()
  }
  ...
  addAngles (position) {
    const { x, y, z } = position
    this.setAngles({ x: this.x + x, y: this.y + y, z: this.z + z })
  }
