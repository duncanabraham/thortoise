...
// const SensorMux = require('./sensorMux') // TODO: there's an issue with the sensor mux registering devices and the BH1750s appearing twice in the registry
...
class Brain extends Feature {
  constructor(options = {}) {
    ...
    // this.sensorArray = new SensorMux({ i2cAddress: 0x77 })
  }
