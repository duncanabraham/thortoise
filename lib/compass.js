...
if (process.env.ENVIRONMENT === 'live') {
  i2c = require('./i2c/i2c-bus')
} else {
  i2c = require('./i2c/mock-i2c-bus')
}
...
/**
 ...
 The public methods are:
  ...
  This is not based on the i2cBase class as the module combines 2 devices into a single output using sensor fusion maths
 */
class Compass {
  constructor (options = {}) {
  ...
  get hasData () {
    return this._lastHeading && this._pitch && this.roll
  }
