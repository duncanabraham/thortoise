class Triplet {
  ...
  constrainServo () {
    this.t1 = this.t1 < 0 ? this.t1 + 180 : this.t1 > 180 ? this.t1 - 180 : this.t1
    this.t2 = this.t2 < 0 ? this.t2 + 180 : this.t2 > 180 ? this.t2 - 180 : this.t2
    this.t3 = this.t3 < 0 ? this.t3 + 180 : this.t3 > 180 ? this.t3 - 180 : this.t3
    this.t1 = this.t1 < 0 ? 0 : this.t1 > 180 ? 180 : this.t1
    this.t2 = this.t2 < 0 ? 0 : this.t2 > 180 ? 180 : this.t2
    this.t3 = this.t3 < 0 ? 0 : this.t3 > 180 ? 180 : this.t3
    return this
  }
}
