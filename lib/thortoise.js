...
class Thortoise {
  ...
  get export () {
    ...
    delete exportObj.brain.navigation
    delete exportObj.brain.sensorArray
    delete exportObj.brain.commandQueue
    delete exportObj.brain.camera
    delete exportObj.brain.running
    delete exportObj.brain.store
