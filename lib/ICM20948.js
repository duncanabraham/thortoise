...
class ICM20948 {
  ...
  readGyro () {
    ...
    const y = this._signedWord(this._readHL(this.REG_ADD_GYRO_XOUT_H + 2))
    const z = this._signedWord(this._readHL(this.REG_ADD_GYRO_XOUT_H + 4))
  ...
  readAccelerometer () {
    ...
    const y = this._signedWord(this._readHL(this.REG_ADD_ACCEL_XOUT_H + 2))
    const z = this._signedWord(this._readHL(this.REG_ADD_ACCEL_XOUT_H + 4))
